...
abaqus.foldername=r'C:\Cloud\OD_OWP\Work\Python\Github\abaqustools\suspensionbridge_example\langenuen'
abaqus.inputname='Langenuen_test'
abaqus.jobname='Langenuen_test'
...
abaqus.foldername_export='C:/Cloud/OD_OWP/Work/Python/Github/abaqustools/odbexport'
...
cable.nodenum_base=np.array([10e3,20e3])
cable.elnum_base=np.array([10e3,20e3])
...
bridgedeck.cs.I12=np.array([2.0])
...
bridgedeck.nodenum_base=np.array([1e3,2e3,3e3,4e3,5e3])
bridgedeck.elnum_base=np.array([1e3,2e3])
bridgedeck.nodenum_base_outer=np.array([11e3,12e3])
bridgedeck.elnum_base_connlat=np.array([3e3,4e3,5e3,6e3,7e3,8e3])
...
hanger.elnum_base=np.array([80e3,90e3])
...
tower.F_pullback_south= np.nan #np.array(-6e5)
...
tower.nodenum_base=np.array([100e3,110e3,200e3,210e3])
tower.elnum_base=np.array([100e3,110e3,200e3,210e3])
...
bearing.nodenum_base=np.array([400e3])
bearing.elnum_base=np.array([400e3])
...
sadle.elnum_base=np.array([300e3])
